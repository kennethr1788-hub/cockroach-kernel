# PDH-3 R12 Paid Remote Preflight Packet R4

Status: `FROZEN_FOR_SAME_HASH_GLM_REVIEW__NO_WORKER_CREATED`

UTC frozen: `2026-08-02T06:44:01Z`
...
At `2026-08-02T06:43:13Z`, Kenneth explicitly removed the prior wait and
authorized immediate launch. R4 changes only the campaign identifier and the
absolute launch, stop, terminate, and closeout times needed to act on that
instruction. R3 remains preserved as superseded timing evidence; no worker was
created and its single attempt was not consumed.
...
- campaign ID and Pod name: `ck-pdh3-r12-preflight-r4-01`;
- cloud: `SECURE`;
...
- launch window: `2026-08-02T06:40:00Z` through
  `2026-08-02T07:40:00Z`;
- provider-native stop-after: `2026-08-02T16:25:00Z`;
- provider-native terminate-after: `2026-08-02T16:40:00Z`;
...
```text
/tmp/runpodctl-v2.7.2-darwin-arm64 pod create --cloud-type SECURE --compute-type GPU --gpu-id NVIDIA GeForce RTX 3090 --gpu-count 1 --image runpod/pytorch:1.0.2-cu1281-torch280-ubuntu2404 --name ck-pdh3-r12-preflight-r4-01 --container-disk-in-gb 250 --volume-in-gb 0 --ports 22/tcp --stop-after 2026-08-02T16:25:00Z --terminate-after 2026-08-02T16:40:00Z --output json
```
