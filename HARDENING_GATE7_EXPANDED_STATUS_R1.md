...
- `STATUS`: `GATE7_A03_AWS_REFRESH_AMENDMENT_SAME_HASH_GREEN`
...
- `REQUIRED_NEXT_GATE`: `START_AND_VERIFY_COORDINATOR_BRIDGE_GUARDS; REACH_CAMPAIGN_READY_BEFORE_HIDDEN_SEED`
