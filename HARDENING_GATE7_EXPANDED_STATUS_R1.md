...
- `STATUS`: `GATE7_A03_CAMPAIGN_READY`
...
- `REQUIRED_NEXT_GATE`: `GENERATE_ONE_HIDDEN_SEED; RUN_ONE_84_ROW_MEASURED_CAMPAIGN_AND_ONE_3600_SECOND_LIVE_TRACK; RETRIEVE_VERIFY_AND_TEARDOWN`
