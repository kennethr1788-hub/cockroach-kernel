...
- `STATUS`: `GATE7_A03_CAMPAIGN_READY_HUMAN_ACTION_REQUIRED`
...
- `REQUIRED_NEXT_GATE`: `REFRESH_PROJECT_LOCAL_AWS_LOGIN; REVERIFY_SESSION_MARGIN; START_AND_VERIFY_COORDINATOR_BRIDGE_GUARDS; REACH_CAMPAIGN_READY_BEFORE_HIDDEN_SEED`
