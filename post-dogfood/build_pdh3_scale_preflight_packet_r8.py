...
CHECKLIST_EVIDENCE = (
    ...
    ("R8-06", "LOCAL_BOUND", (("post-dogfood/run_pdh3_scale_campaign.py", "prove_preseed_vector_index"), ("post-dogfood/run_pdh3_scale_campaign.py", "vector_seed_statement"), ("post-dogfood/run_pdh3_scale_campaign.py", "vector_index_quality"), ("post-dogfood/run_pdh3_scale_campaign.py", "prove_seeded_vector_index"), ("post-dogfood/run_pdh3_scale_campaign.py", "recover_cluster_gateway")), (("post-dogfood/test_pdh3_scale_campaign.py", "test_precreated_vector_index_is_proved_without_schema_ddl"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_vectors_seed_through_single_row_concurrent_client"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_seed_vectors_are_distributed_stable_and_sql_reconcilable"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_vector_insert_is_parameterized_single_row"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_vector_client_retry_classification_is_fail_closed"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_vector_index_quality_uses_exact_baseline_and_forced_ann"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_vector_index_low_recall_fails_closed"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_cluster_gateway_recovery_restarts_dead_node_and_fails_over"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_cluster_recovery_restarts_node_that_dies_during_recovery")), ("local_test_manifest.tests",)),
    ...
    ("R8-17", "LOCAL_BOUND", (("post-dogfood/run_pdh3_scale_campaign.py", "start_cluster"), ("post-dogfood/run_pdh3_scale_campaign.py", "capture_node_diagnostics")), (("post-dogfood/test_pdh3_scale_campaign.py", "test_partial_cluster_start_failure_stops_started_nodes"), ("post-dogfood/test_pdh3_scale_campaign.py", "test_failure_node_diagnostics_preserve_bounded_log_evidence")), ("local_test_manifest.tests",)),
...
CHECKLIST_REQUIREMENTS = {
    ...
    "R8-06": "The precreated vector index, four persistent single-row clients, deterministic distributed vectors, exact full content reconciliation, forced-index ANN recall against exact primary-index baselines, queryability, and continuously supervised three-node recovery are proved without nonempty-table DDL.",
    ...
    "R8-17": "Partial cluster startup tears down every started node and blocked runs preserve bounded node diagnostics before cleanup.",
