# Independent GLM Audit Instructions — Fresh-Context Black-Box Plan R2B
...
The external direct wrapper has independently required and verified the served
model as `glm-5.2`. Do not infer, substitute, or invent another provider/model
identity from your internal persona or training context. In the required output,
return exactly:
...
Any different value invalidates the result regardless of the substantive
verdict.
