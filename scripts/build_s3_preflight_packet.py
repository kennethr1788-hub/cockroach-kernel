...
OUTPUT = ROOT / "S3_PREFLIGHT_PACKET_R11.md"
...
FILES = [
    ...
    ROOT / "S3_PREFLIGHT_REPAIR_RECEIPT_R11.md",
    ROOT / "S3_AWS_AUTH_RESOLUTION_RECEIPT_R1.md",
    ROOT / "S3_ATTEMPT_A03_RECEIPT.md",
    ...
    ROOT / "S3_STATUS.md",
    ROOT / "S3_PREFLIGHT_CHECKPOINT_R11.md",
