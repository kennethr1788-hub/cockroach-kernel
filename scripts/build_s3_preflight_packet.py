...
OUTPUT = ROOT / "S3_PREFLIGHT_PACKET_R8.md"
...
FILES = [
    ...
    ROOT / "S3_PREFLIGHT_REPAIR_RECEIPT_R8.md",
    ROOT / "S3_ATTEMPT_A01_RECEIPT.md",
    ...
    ROOT / "S3_STATUS.md",
    ROOT / "S3_PREFLIGHT_CHECKPOINT_R8.md",
