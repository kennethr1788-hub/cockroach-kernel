...
- `PASSWORD_CLIPBOARD_STATE`: `cleared_after_AWS_secret_handoff`
- `GRANT_EXECUTION_RESULT`: `Success`
- `AWS_SECRET_CREATED`: `yes`
- `FIRST_HANDOFF_ATTEMPT`: `HARDENING_GATE2_SECRET_HANDOFF_ATTEMPT_R1.md`
- `SECOND_HANDOFF_ATTEMPT`: `HARDENING_GATE2_SECRET_HANDOFF_ATTEMPT_R2.md`
- `FINAL_HANDOFF_RECEIPT`: `HARDENING_GATE2_SECRET_RECEIPT_R1.md`
