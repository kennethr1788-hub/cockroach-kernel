...
- `NEXT_ALLOWED_ACTION`: Prepare EV1-T07 under the frozen expected-invalid oversized-state contract; preserve INVALID as the intended safety outcome and stop at its human gate
...
- `CURRENT_COMMIT`: `2499f5cbc39eb7cb4796661c7254f5e192baad8d`
- `LAST_VERIFIED_UTC`: `2026-07-30T19:42:24Z`
...
- `PENDING_BLOCKERS`: `NONE_BEFORE_EV1_T07_PREPARATION`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T05 final objective-evidence direct GLM 5.2 is GREEN and T05 is closed; EV1-T06 guarded-execution review remains prospective after its exact-state declaration`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T06_TEARDOWN_RECEIPT_R1.md`
