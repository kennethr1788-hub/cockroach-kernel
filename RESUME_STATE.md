...
- `NEXT_ALLOWED_ACTION`: Kenneth confirms or corrects the two qualified EV1-T06 operator observations; then freeze the objective-evidence packet, obtain final direct GLM 5.2 review, tear down the preserved successor only after GREEN, and close EV1-T06
...
- `PENDING_BLOCKERS`: `EV1_T06_OPERATOR_OBSERVATIONS_REQUIRED; final objective-evidence GLM 5.2 review and teardown remain prospective`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T06_MECHANICAL_RESULT_R1.md`
