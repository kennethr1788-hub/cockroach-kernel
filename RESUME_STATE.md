...
- `PENDING_BLOCKERS`: `EV1-T04 exact-state capture declaration required from Kenneth; capture, deletion, and recovery have not started`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T03 task-specific preflight and objective-evidence audits are GREEN; EV1-T04 requires exact-state declaration followed by its own task-specific independent preflight; Item 5 final review remains complete`
