...
- `NEXT_ALLOWED_ACTION`: Capture the exact authorized EV1-T10 state and run the task-specific local execution preflight while preserving the original workspace; freeze one sanitized execution packet and require same-hash GLM 5.2 and AGY GREEN before deletion/recovery
...
- `CURRENT_COMMIT`: `09752b831932fece1087a9300d9efcd2ea413af3`
- `LAST_VERIFIED_UTC`: `2026-07-30T22:28:25Z`
...
- `PENDING_BLOCKERS`: `EV1_T10_INDEPENDENT_EXECUTION_PREFLIGHT_GREEN_REQUIRED_BEFORE_DELETION; EV1_T09_INDEPENDENT_HUMAN_EDIT_CLAIM_PERMANENTLY_EXCLUDED; EV1_T07_AND_T08_EXPECTED_INVALID_WORKSPACES_MUST_REMAIN_PRESERVED`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T10 requires same-hash GLM 5.2 and AGY GREEN over the frozen execution packet after local preflight and before deletion/recovery; builder may not self-approve`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T10_CAPTURE_AUTHORIZATION_R1.md; exact state reverified; capture/deletion/recovery authorized subject to independent execution preflight`
