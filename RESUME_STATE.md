...
- `NEXT_ALLOWED_ACTION`: Freeze one sanitized byte-complete packet and obtain required GLM plus Claude GREEN before any RunPod creation
...
- `LATEST_CHECKPOINT`: `S3_PREFLIGHT_CHECKPOINT_R3.md`
