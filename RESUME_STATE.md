...
- `NEXT_ALLOWED_ACTION`: Create and verify attempt A02; only after exact worker verification start guards, transfer immutable bundles, and prove campaign-ready
...
- `LATEST_CHECKPOINT`: `S3_PREFLIGHT_CHECKPOINT_R8.md`
- `S3_LOCAL_PREFLIGHT`: `R8_GLM_5_2_AND_CLAUDE_OPUS_4_8_GREEN`
