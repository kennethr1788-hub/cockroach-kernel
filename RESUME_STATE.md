...
- `NEXT_ALLOWED_ACTION`: Freeze the exact Run 5 attempt request from the current GREEN AWS/Cockroach readiness receipt and empty RunPod inventory, then create and verify one bounded worker before hidden-seed creation
...
- `CURRENT_COMMIT`: `d43e5fa1d63fa896709b39a2439f310dcb5fbfd6`
...
- `GATE7_RUN5_CLOUD_AUTH`: `GREEN; COCKROACH_HOST_ONLY_ADAPTER_GREEN; PROJECT_LOCAL_AWS_CK_S3_GREEN; READINESS_RECEIPT_SHA256_e1324bf81bbf67ac9c2d03b27f18577e5ee5e9d1a2b2abada16c9103836b0ac3; NO_WORKER_CREATED; NO_HIDDEN_SEED`
...
- `PENDING_BLOCKERS`: `RUN3_IMMUTABLY_BLOCKED`; `RUN4_IMMUTABLY_BLOCKED`; Run 5 public canaries R1 through R4 remain BLOCKED; worker identity, price, transfer, isolation, lifecycle, and CAMPAIGN_READY checks remain open; no current Run 5 worker or hidden seed exists
...
- `LATEST_CHECKPOINT`: `HARDENING_GATE7_RUN5_PREFLIGHT_JUDGE_RECEIPT_R1.md`
