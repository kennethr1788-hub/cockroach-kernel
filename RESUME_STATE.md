...
- `REQUIRED_JUDGE_STATE`: `EV1-T09 execution preflight GREEN; final objective-evidence GLM audit remains prospective after Kenneth's two operator observations; builder may not self-close the task`
