...
- `REQUIRED_JUDGE_STATE`: `EV1-T11 work is locally GREEN but capture/deletion remains blocked; after Kenneth's exact-state declaration, require fresh GLM 5.2 and AGY GREEN over one identical execution packet before deletion`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T11_WORK_R1.md; local work GREEN; exact-state capture declaration required; no capture, deletion, or recovery started`
