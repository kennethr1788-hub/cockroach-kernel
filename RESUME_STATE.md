...
- `CURRENT_PHASE`: `HARDENING_7_RUN3_CAMPAIGN_READY`
- `LAST_GREEN_GATE`: `GATE7_RUN3_R5_PREFLIGHT_GREEN`
- `NEXT_ALLOWED_ACTION`: checkpoint the A01 CAMPAIGN_READY receipt, then create the one authorized hidden seed and execute the three frozen measured tracks exactly once
...
- `CURRENT_COMMIT`: `6dc1bf428f69b57697242ae985834b6725c041c8` (pre-CAMPAIGN_READY checkpoint)
...
- `GATE7B_STATE`: `CAMPAIGN_READY; A01_RUNNING; EXTRACTED_CANARIES_GREEN; HIDDEN_SEED_ABSENT; MEASURED_EXECUTION_ABSENT`
...
- `PENDING_BLOCKERS`: `none`; A01 is CAMPAIGN_READY, hidden seed is absent, and measured execution has not started
...
- `LATEST_CHECKPOINT`: `HARDENING_GATE7_RUN3_CAMPAIGN_READY_RECEIPT_R1.md`
