...
- `PENDING_BLOCKERS`: `EV1_T07_EXACT_STATE_CAPTURE_DECLARATION_REQUIRED; HUMAN_ONLY; PREDECLARED_INVALID_OVERSIZED_RECORD; DELETION_FORBIDDEN_AFTER_INVALID`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T06 final objective-evidence direct GLM 5.2 is GREEN and T06 is closed; EV1-T07 guarded capture-only preflight remains prospective after Kenneth's exact-state declaration`
