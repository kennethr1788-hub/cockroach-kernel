...
- `NEXT_ALLOWED_ACTION`: Prepare and execute frozen EV1-T12 only after verifying its source binding, acceptance contract, prior T11 teardown receipt, and all current hashes
...
- `CURRENT_COMMIT`: `afa00dfe04d6a9532d3a9b145d4275e61fb55e11`
- `LAST_VERIFIED_UTC`: `2026-07-30T23:51:14Z`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T11 closed; EV1-T12 requires its task-specific local and independent pre-execution gates before any guarded deletion`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T11_CLOSEOUT_R1.md; EV1-T11 closed evaluable pass; EV1-T12 is next`
