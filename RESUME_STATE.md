...
- `NEXT_ALLOWED_ACTION`: Prepare EV1-T08 from its frozen source under the predeclared unsafe-symlink expected-invalid contract; preserve the EV1-T07 workspace intact and stop at the next human gate
...
- `CURRENT_COMMIT`: `0cbe115524ab1ef4fa39bfcb7f66a4eb149e0568`
- `LAST_VERIFIED_UTC`: `2026-07-30T20:30:14Z`
...
- `PENDING_BLOCKERS`: `NONE_BEFORE_EV1_T08_PREPARATION; EV1_T07_WORKSPACE_PRESERVATION_IS_LOAD_BEARING`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T07 corrected result audit direct GLM 5.2 is GREEN and T07 is closed expected-invalid; EV1-T08 guarded expected-invalid review remains prospective after its exact-state declaration`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T07_RESULT_R1.md; exact T07 workspace preserved after expected INVALID`
