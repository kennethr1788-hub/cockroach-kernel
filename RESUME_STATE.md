...
- `NEXT_ALLOWED_ACTION`: Validate and checkpoint the immutable EV1-T11 runner and Kenneth's recorded exact-state authorization, then run capture and local preflight; guarded deletion remains forbidden until fresh GLM 5.2 and AGY GREEN over one identical execution packet
...
- `CURRENT_COMMIT`: `96277593ed7f3768174e0cf53309a413b9d8dd7e`
- `LAST_VERIFIED_UTC`: `2026-07-30T23:22:19Z`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T11 exact-state authorization is recorded; require local capture/preflight plus fresh GLM 5.2 and AGY GREEN over one identical execution packet before deletion`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T11_CAPTURE_AUTHORIZATION_R1.md; exact-state authorization recorded; no capture, deletion, or recovery started`
