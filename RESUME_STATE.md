...
- `NEXT_ALLOWED_ACTION`: Run the frozen Gate 2 live positive, refusal, determinism, negative-surface, replay-equivalence, database/query-plan, access, and cost checks; then freeze the final Gate 2 packet for GLM
...
- `LATEST_CHECKPOINT`: `HARDENING_GATE2_AWS_DEPLOYMENT_RECEIPT_R1.md`
...
- `HARDENING_GATE2_STATUS`: `DEPLOYED_CONFIGURATION_GREEN_BEHAVIOR_PENDING`
