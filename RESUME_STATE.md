...
- `NEXT_ALLOWED_ACTION`: Kenneth explicitly declares the exact EV1-T08 regular-file state and untracked escape symlink permitted for capture only; no target read, modification, deletion, workspace deletion, or recovery is authorized after INVALID
...
- `CURRENT_COMMIT`: `0f86523a9e946d1e2f93bc7bfdbc841a0c3d4227`
- `LAST_VERIFIED_UTC`: `2026-07-30T20:36:42Z`
...
- `PENDING_BLOCKERS`: `EV1_T08_EXACT_STATE_CAPTURE_DECLARATION_REQUIRED; HUMAN_ONLY; PREDECLARED_INVALID_UNSAFE_SYMLINK_ESCAPE; TARGET_AND_WORKSPACE_DELETION_FORBIDDEN_AFTER_INVALID; EV1_T07_WORKSPACE_PRESERVATION_IS_LOAD_BEARING`
