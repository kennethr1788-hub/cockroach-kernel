...
- `CURRENT_PHASE`: `S3_PREFLIGHT_R4`
- `LAST_GREEN_GATE`: `CK_P9_INTEGRATION_GREEN`
- `NEXT_ALLOWED_ACTION`: Freeze R4 with concrete schedule and retrieval wiring, then obtain fresh GLM plus Claude GREEN
- `FORBIDDEN_ACTIONS`: RunPod creation before R4 preflight GREEN; feature additions after P9; P10 or later; public actions; release; submission; HOME/live-memory mutation; credential exposure; more than one worker; any worker credential transfer
...
- `PENDING_BLOCKERS`: R4 GLM plus Claude preflight review, RunPod campaign-ready proof, 43,200-second production soak, teardown, and final GLM plus Claude plus AGY review remain incomplete
...
- `LATEST_CHECKPOINT`: `S3_PREFLIGHT_JUDGE_RECEIPT_R3.md`
