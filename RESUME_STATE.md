...
- `NEXT_ALLOWED_ACTION`: Preserve the invalid GLM transport attempt, rerun the unchanged EV1-T09 execution-preflight packet through GLM 5.2 and AGY, and begin guarded deletion/recovery only if both independent judges return validated GREEN
...
- `PENDING_BLOCKERS`: `EV1_T09_EXECUTION_PREFLIGHT_INDEPENDENT_GREEN_REQUIRED_BEFORE_DELETION; EV1_T09_INDEPENDENT_HUMAN_EDIT_CLAIM_PERMANENTLY_EXCLUDED; EV1_T07_AND_T08_EXPECTED_INVALID_WORKSPACES_MUST_REMAIN_PRESERVED`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T09 unchanged execution-preflight packet 341a54c7528213f76896237b2387dd1dfdf2845fb472ebac2929a7fdea1b6f50 requires validated GLM 5.2 and AGY GREEN before guarded deletion/recovery; GLM R1 transport was invalid with no verdict and is preserved`
