...
- `PENDING_BLOCKERS`: `NONE_FOR_EV1_T04; EV1-T05 preparation remains prospective`
...
- `REQUIRED_JUDGE_STATE`: `EV1-T04 preflight GLM 5.2 and AGY plus final objective-evidence GLM 5.2 audit are GREEN; EV1-T05 requires its own task-specific evidence gates`
...
- `LATEST_CHECKPOINT`: `EXTERNAL_VALIDITY_EV1_T04_STATUS_R1.md`
