#!/usr/bin/env python3
"""Tear down only the bounded EV1-T10 temporary successor after final audit."""
...
TARGET = Path("/private/tmp/ck-ev1-t10-r1")
SNAPSHOT = CONTROL / "POST_RECOVERY_SNAPSHOT"
TASK_RECEIPT = CONTROL / "TASK_EXECUTION_RECEIPT.json"
AUDIT_RAW = CONTROL / "EV1_T10_RESULT_AUDIT_GLM_RAW_R1.txt"
AUDIT_REPORT = ROOT / "EXTERNAL_VALIDITY_EV1_T10_RESULT_AUDIT_R1.md"
TEARDOWN_RECEIPT = CONTROL / "TEARDOWN_RECEIPT.json"
EXPECTED_TASK_FILE_SHA256 = "c6318481c5a58b3f71fb0d9a5d207ee1c0f6449e59245b920b124c44040c128e"
EXPECTED_TASK_RECEIPT_SHA256 = "790b3ea9e3c5be7f8c6122c82134d6633a5bd69cfedc1707ce1b935a33392d01"
EXPECTED_AUDIT_RAW_SHA256 = "49dfb2937704f397fe7db71192dc06498437b1554745bdb9b07b7e0356733dea"
EXPECTED_AUDIT_REPORT_SHA256 = "e3e4a2b62fda970b1fd74d2d304f4cbc49f3b04369412678b644c98539e35168"
...
def main() -> int:
    ...
    if task.get("independent_human_edit_claim") != "NOT_REQUIRED_BY_FROZEN_TASK":
    ...
    body = {
        "version": "ev1-t10-teardown-receipt-v1",
        "status": "EV1_T10_TEMPORARY_SUCCESSOR_TEARDOWN_GREEN",
        "task_id": "EV1-T10",
        "exact_teardown_root": "/private/tmp/ck-ev1-t10-r1",
