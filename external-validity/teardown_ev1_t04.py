#!/usr/bin/env python3
"""Tear down only the bounded EV1-T04 temporary successor after final audit."""
...
CAMPAIGN = ROOT / ".ev1-runtime" / "EV1-T04"
CONTROL = CAMPAIGN / "control"
TARGET = Path("/private/tmp/ck-ev1-t04-r1")
SNAPSHOT = CONTROL / "POST_RECOVERY_SNAPSHOT"
TASK_RECEIPT = CONTROL / "TASK_EXECUTION_RECEIPT.json"
AUDIT_RAW = CONTROL / "EV1_T04_RESULT_AUDIT_GLM_RAW_R1.txt"
TEARDOWN_RECEIPT = CONTROL / "TEARDOWN_RECEIPT.json"
EXPECTED_TASK_FILE_SHA256 = "61f78eb3c4d2b43fc9ec4f08382c2c2712c8661892946bba805f433781f89fc4"
EXPECTED_TASK_RECEIPT_SHA256 = "12f186dfa6f1d2d70372fa80b1ea82b0b03a713edf2faf155b5c7a6ba2a5a7e5"
EXPECTED_AUDIT_RAW_SHA256 = "59d97880c4cfeee05fcc5f461f5218c3620d3ed017ec9cdc699c206ed1dacf1c"
...
def main() -> int:
    ...
    body = {
        "version": "ev1-t04-teardown-receipt-v1",
        "status": "EV1_T04_TEMPORARY_SUCCESSOR_TEARDOWN_GREEN",
        "task_id": "EV1-T04",
        "exact_teardown_root": "/private/tmp/ck-ev1-t04-r1",
