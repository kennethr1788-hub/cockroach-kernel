#!/usr/bin/env python3
"""Build the byte-frozen EV1-T04 destructive-execution review packet."""
...
RUNNER = ROOT / "external-validity" / "run_ev1_t04.py"
...
PRODUCT_LOG = CONTROL / "t04-product-preflight.log"
DEPENDENCY_LOG = CONTROL / "t04-dependency-topology-preflight.log"
BODY = CONTROL / "EV1_T04_EXECUTION_PREFLIGHT_BODY_R1.md"
PACKET = CONTROL / "EV1_T04_EXECUTION_PREFLIGHT_PACKET_R1.md"
...
def main() -> int:
    ...
    body_parts = [
        "# EV1-T04 Guarded Execution Review Body R1\n",
        ...
        "of only the disposable EV1-T04 workspace, create an empty-history successor, recover exactly "
        "five hash-bound files through the unchanged product candidate, run the frozen Pacific and "
        "UTC dashboard-date tests, typecheck, and production build offline, preserve failures, and "
        "stop for operator observation.\n",
        "## Blocking criteria\n\n"
