#!/usr/bin/env python3
"""Tear down only the bounded EV1-T09 temporary successor after final audit."""
...
TARGET = Path("/private/tmp/ck-ev1-t09-r1")
SNAPSHOT = CONTROL / "POST_RECOVERY_SNAPSHOT"
TASK_RECEIPT = CONTROL / "TASK_EXECUTION_RECEIPT.json"
AUDIT_RAW = CONTROL / "EV1_T09_RESULT_AUDIT_GLM_RAW_R2.txt"
AUDIT_REPORT = ROOT / "EXTERNAL_VALIDITY_EV1_T09_RESULT_AUDIT_R1.md"
TEARDOWN_RECEIPT = CONTROL / "TEARDOWN_RECEIPT.json"
EXPECTED_TASK_FILE_SHA256 = "8d5c8ff546d246b2416fec28eda6fdb55469f1e60c46f2db4855acfcd336f522"
EXPECTED_TASK_RECEIPT_SHA256 = "9f509aabe28031f6b499939dd54a76c284941711ec11000952efc09874c97f5a"
EXPECTED_AUDIT_RAW_SHA256 = "5809ced5e7a484124bd24acbfa5b218d8e38eaeaa0c29051228942babe8d5b75"
EXPECTED_AUDIT_REPORT_SHA256 = "fc27a8741bf99f43b58e7e3f0d006dac31c7945f5dac17d308a06d5fede51342"
...
def main() -> int:
    ...
    if task.get("independent_human_edit_claim") != "PERMANENTLY_EXCLUDED_FOR_EV1_T09":
    ...
    body = {
        "version": "ev1-t09-teardown-receipt-v1",
        "status": "EV1_T09_TEMPORARY_SUCCESSOR_TEARDOWN_GREEN",
        "task_id": "EV1-T09",
        "exact_teardown_root": "/private/tmp/ck-ev1-t09-r1",
