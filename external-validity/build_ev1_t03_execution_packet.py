#!/usr/bin/env python3
"""Build the byte-frozen EV1-T03 destructive-execution review packet."""
...
RUNNER = ROOT / "external-validity" / "run_ev1_t03.py"
...
def main() -> int:
    ...
    body_parts = [
        "# EV1-T03 Guarded Execution Review Body R1\n",
        ...
        "of only the disposable EV1-T03 workspace, create an empty-history successor, recover exactly "
