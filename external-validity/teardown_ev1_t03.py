#!/usr/bin/env python3
"""Tear down only the bounded EV1-T03 temporary successor after final audit."""
...
CAMPAIGN = ROOT / ".ev1-runtime" / "EV1-T03"
CONTROL = CAMPAIGN / "control"
TARGET = Path("/private/tmp/ck-ev1-t03-r1")
SNAPSHOT = CONTROL / "POST_RECOVERY_SNAPSHOT"
TASK_RECEIPT = CONTROL / "TASK_EXECUTION_RECEIPT.json"
AUDIT_RAW = CONTROL / "EV1_T03_RESULT_AUDIT_GLM_RAW_R1.txt"
TEARDOWN_RECEIPT = CONTROL / "TEARDOWN_RECEIPT.json"
EXPECTED_TASK_FILE_SHA256 = "841910fa50b3420de7233fc49eba5c7cef7a22ddeef44e66ef667d81e45e6667"
EXPECTED_TASK_RECEIPT_SHA256 = "b0209d1a4e40aa5ea05ad39587be96d8b7dee855c7cacfc488d6cda4ee8158da"
EXPECTED_AUDIT_RAW_SHA256 = "79dadf59b3fd21056a532aaa2512bf08b4c606943d1dab7ad540f0b73ed6623d"
...
def main() -> int:
    ...
    body = {
        "version": "ev1-t03-teardown-receipt-v1",
        "status": "EV1_T03_TEMPORARY_SUCCESSOR_TEARDOWN_GREEN",
        "task_id": "EV1-T03",
        "exact_teardown_root": "/private/tmp/ck-ev1-t03-r1",
