#!/usr/bin/env python3
"""Tear down only the bounded EV1-T05 temporary successor after final audit."""
...
CAMPAIGN = ROOT / ".ev1-runtime" / "EV1-T05"
CONTROL = CAMPAIGN / "control"
TARGET = Path("/private/tmp/ck-ev1-t05-r1")
SNAPSHOT = CONTROL / "POST_RECOVERY_SNAPSHOT"
TASK_RECEIPT = CONTROL / "TASK_EXECUTION_RECEIPT.json"
AUDIT_RAW = CONTROL / "EV1_T05_RESULT_AUDIT_GLM_RAW_R1.txt"
TEARDOWN_RECEIPT = CONTROL / "TEARDOWN_RECEIPT.json"
EXPECTED_TASK_FILE_SHA256 = "db67858de3fedbe31eeb5cde61104988dcc6df68c263f30f4f35a0d267de8985"
EXPECTED_TASK_RECEIPT_SHA256 = "75bd558c71bf633962b567cebf5dc19bd0a89110a76627d8a10727365df9de8c"
EXPECTED_AUDIT_RAW_SHA256 = "96e5b91e2ccccd455882b6e0db43680ae447cacd3725907e76f99f3cb2002ab2"
...
def main() -> int:
    ...
    body = {
        "version": "ev1-t05-teardown-receipt-v1",
        "status": "EV1_T05_TEMPORARY_SUCCESSOR_TEARDOWN_GREEN",
        "task_id": "EV1-T05",
        "exact_teardown_root": "/private/tmp/ck-ev1-t05-r1",
