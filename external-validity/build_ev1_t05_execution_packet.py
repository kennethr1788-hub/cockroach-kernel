#!/usr/bin/env python3
"""Build the byte-frozen EV1-T05 guarded-execution review packet."""
...
RUNNER = ROOT / "external-validity" / "run_ev1_t05.py"
...
LOGS = (
    CONTROL / "t05-product-preflight.log",
    CONTROL / "t05-dependency-preflight-signal-schema.log",
    CONTROL / "t05-dependency-preflight-typecheck.log",
    CONTROL / "t05-dependency-preflight-build.log",
)
BODY = CONTROL / "EV1_T05_EXECUTION_PREFLIGHT_BODY_R1.md"
PACKET = CONTROL / "EV1_T05_EXECUTION_PREFLIGHT_PACKET_R1.md"
...
def main() -> int:
    ...
    body_parts = [
        "# EV1-T05 Guarded Execution Review Body R1\n",
        ...
        "of only the disposable EV1-T05 workspace, create an empty-history successor from the "
        "separately attributed ordinary-Git baseline, recover exactly five hash-bound task files "
        "through the unchanged product candidate, run the frozen schema suite, typecheck, and "
